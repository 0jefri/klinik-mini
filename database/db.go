...
func InitDB() {
	...
	db.AutoMigrate(&model.Access{}, &model.Role{}, &model.RoleAccess{}, &model.Address{}, &model.Contact{}, &model.Insurance{}, &model.PersonIdentity{}, &model.Person{}, &model.PersonInsurance{}, &model.Account{}, &model.AccountAccess{})
